...
# print(age2 + 10)
'''
input() 함수의 return 자료형은 str이다.
그래서 수학적인 연산을 하기 위해서는 형변환 함수인 int() / float()을 사용할 필요가 있다.
'''
# age = float(input('당신의 나이를 입력하세요>>>'))
# input의 결과값은 자료형은 str이고 그걸 다시 int / float으로 바꾸는 함수가 적용되어 일종의 chaining method 처럼 쓸 수 있다
# print(f'당신의 나이는 {age}살이고, 내년에는 {age+1}살이 된다.')
# if age > 19:
#     print('성인입니다.')
...
'''
age = 21
has_ticket = True # boolean  자료형일 때 python은 java 와 javascript와 달리 대문자로 시작한다.
